set -x
DATA_ROOT_DIR=/xxx/r1/wanjuan
CKPT_ROOT_DIR=/xxx/r1_model
PROJECT_NAME=verl_grpo_wanjuan
EXPERIMENT_NAME=wanjuan_rollout8
BASE_MODEL=/xxx/qwen-25-1_5b
wandb login xxx
...
python3 -m verl.trainer.main_ppo \
    ...
    data.train_files=$DATA_ROOT_DIR/wanjuan_exam_train.parquet \
    data.val_files=$DATA_ROOT_DIR/wanjuan_exam_test.parquet \
